  ...
  return (
    <div>
      <section className="rounded bg-neutral-100 py-8 sm:py-12">
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-items-center gap-8 px-12 sm:px-16">
          ...
          <Image className="rounded" alt="Hero Image" width={380} height={380} src={products.data[0].images[0]} />
        </div>
      </section>
